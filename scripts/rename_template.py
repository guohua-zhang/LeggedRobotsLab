...
It renames all the occurrences of leggedrobotslab (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the leggedrobotslab folder
        os.rename(
            os.path.join(root_dir_path, "exts", "leggedrobotslab", "leggedrobotslab"),
            os.path.join(root_dir_path, "exts", "leggedrobotslab", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "leggedrobotslab"), os.path.join(root_dir_path, "exts", new_name))
