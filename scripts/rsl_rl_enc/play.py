...
parser.add_argument("--seed", type=int, default=66, help="Seed used for the environment")
...
def main():
    ...
    # priprioencoder_obs = obs_dict["observations"]["priprioencoder"]
    ...
    while simulation_app.is_running():
        ...
        with torch.inference_mode():
            ...
            if agent_cfg.runner_type == "OnPolicyRunner":
                ...
                # actions = policy(obs, critic_obs, priprioencoder_obs)
