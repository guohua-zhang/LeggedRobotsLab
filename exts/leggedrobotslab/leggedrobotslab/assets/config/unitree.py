...
* :obj:`UNITREE_GO2W_CFG`: Unitree GO2W robot with DC motor model for the legs
...
UNITREE_A1_CFG_usd_path = os.path.join(current_dir, "../usd/Unitree/A1/a1.usd")
UNITREE_GO2W_CFG_usd_path = os.path.join(current_dir, "../usd/Unitree/Go2W/go2w.usd")
...
UNITREE_GO2W_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=UNITREE_GO2W_CFG_usd_path,
...
UNITREE_A1_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        ...
        # usd_path=UNITREE_A1_CFG_usd_path,
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
