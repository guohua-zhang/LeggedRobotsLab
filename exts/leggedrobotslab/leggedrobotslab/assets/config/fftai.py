...
FFTAI_GR1T1_CFG_usd_path = os.path.join(current_dir, "../usd/FFTAI/GR1T1/GR1T1.usd")
FFTAI_GR1T1_LOWER_LIMB_CFG_usd_path = os.path.join(current_dir, "../usd/FFTAI/GR1T1/GR1T1_lower_limb.usd")
...
FFTAI_GR1T1_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=FFTAI_GR1T1_CFG_usd_path,
...
FFTAI_GR1T1_LOWER_LIMB_CFG.spawn.usd_path = FFTAI_GR1T1_LOWER_LIMB_CFG_usd_path
