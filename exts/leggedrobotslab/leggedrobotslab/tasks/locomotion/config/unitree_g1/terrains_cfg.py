...
#############################
# Rough Terrain Configuration v1
#############################

BLIND_ROUGH_TERRAINS_CFG_v1 = TerrainGeneratorCfg(
    seed=66, # 42,
    size=(8.0, 8.0),
    border_width=20.0,
    num_rows=10,
    ...
    sub_terrains={
        ...
        "boxes": MeshRandomGridTerrainCfg(
            proportion=0.15, grid_width=0.15, grid_height_range=(0.01, 0.04), platform_width=2.0
        ),
        "random_rough": HfRandomUniformTerrainCfg(
...
BLIND_ROUGH_TERRAINS_PLAY_CFG_v1 = TerrainGeneratorCfg(
    seed=66, # 42,
    size=(8.0, 8.0),
    border_width=20.0,
    num_rows=4,
